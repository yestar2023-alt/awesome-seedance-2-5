...
- [Reddit creator cases — CR-56 ～ CR-62](./cases/creator-reported-reddit-2026-08-10.md): 七个独立创作者公开的成片帖与完整 prompt，覆盖第一人称动作、30 秒手持单镜头、双参考对话、旅行 Vlog、多房间转场、咖啡制作和日常纪实。

目前共 **71 个**带可播放视频链接与完整 prompt 的案例，覆盖：
