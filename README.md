...
- [Reddit creator cases — CR-56 ～ CR-57](./cases/creator-reported-reddit-2026-08-10.md): 两个独立创作者公开的成片帖与完整 prompt，覆盖第一人称动作与 30 秒手持单镜头。

目前共 **66 个**带可播放视频链接与完整 prompt 的案例，覆盖：
