...
- [X creator cases — CR-65 ～ CR-68](./cases/creator-reported-x-2026-08.md): 四条原作者公开的 Seedance 2.5 成片与 prompt 文本，涵盖复古奇幻、机甲追逐、产品广告和旅行 Vlog；CR-68 明确标为 `partial`。

目前共 **77 个**带可播放视频链接的案例；其中 **75 个**公开完整 prompt，**2 个**仅公开部分 prompt（CR-64、CR-68），覆盖：
